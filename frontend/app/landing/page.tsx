    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      <nav className="p-6 flex justify-between max-w-7xl mx-auto">
        ...
        <div className="flex gap-4 text-sm">
          ...
          <Link href="/pricing" className="px-4 py-2 rounded-full bg-white text-black font-bold">เริ่มบิน →</Link>
        </div>
      </nav>
      ...
      <section className="text-center py-20 px-6">
        ...
        <div className="mt-8 flex justify-center gap-4">
          <Link href="/" className="px-8 py-4 rounded-2xl bg-white text-black font-bold text-lg">เริ่มบินฟรี 20 ครั้ง →</Link>
